...
export const CONVERSATION = {
  ...
  TIER1_MESSAGE_COUNT: 6,
  TIER2_MESSAGE_COUNT: 20,
  TIER3_SUMMARY_MAX_TOKENS: 200,
  ONBOARDING_MIN_PREFERENCES: 4,
  ONBOARDING_MIN_CONFIDENCE: 0.5,
} as const;
...
export const AI = {
  ...
  BACKGROUND_MODEL: 'claude-haiku-4-5-20251001' as const,
